...
public class DataStructure {
	...
	/*
	 * Calculate the total calories being consumed
	 * 
	 * @return the total calories being consumed
	 */
	public int totalCal() {
		int totalCal = 0;
	...
	/*
	 * Calculate the total calories being burned
	 * 
	 * @return the total calories being burned
	 */
